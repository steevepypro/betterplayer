...
class BplayerVideoProgressBar extends StatefulWidget {
  BplayerVideoProgressBar(
    this.controller,
...
class _VideoProgressBarState
    extends State<BplayerVideoProgressBar> {
