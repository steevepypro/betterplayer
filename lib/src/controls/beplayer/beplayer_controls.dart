...
class BeplayerControls extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _BeplayerControlsState();
  }
}

class _BeplayerControlsState
    extends BetterPlayerControlsState<BeplayerControls> {
